...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 13-01-01 | 01 | 0 | RAWTERM-01..06 | unit stubs | `npx vitest run tests/App.rawTerminal.test.tsx` | ❌ W0 | ⬜ pending |
| 13-01-02 | 01 | 1 | RAWTERM-01 | unit | `npx vitest run tests/App.rawTerminal.test.tsx` | ✅ W0 | ⬜ pending |
| 13-01-03 | 01 | 1 | RAWTERM-02 | unit | `npx vitest run tests/App.rawTerminal.test.tsx` | ✅ W0 | ⬜ pending |
| 13-02-01 | 02 | 1 | RAWTERM-03 | unit | `npx vitest run tests/App.rawTerminal.test.tsx` | ✅ W0 | ⬜ pending |
| 13-02-02 | 02 | 1 | RAWTERM-04 | unit | `npx vitest run tests/App.rawTerminal.test.tsx` | ✅ W0 | ⬜ pending |
| 13-02-03 | 02 | 1 | RAWTERM-05 | unit | `npx vitest run tests/App.rawTerminal.test.tsx` | ✅ W0 | ⬜ pending |
| 13-02-04 | 02 | 1 | RAWTERM-06 | unit | `npx vitest run tests/App.rawTerminal.test.tsx` | ✅ W0 | ⬜ pending |
...
- [ ] `tests/App.rawTerminal.test.tsx` — stubs for RAWTERM-01 through RAWTERM-06
