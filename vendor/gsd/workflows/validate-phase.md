...
```
Task(
  prompt="Read /Users/rgv250cc/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/rgv250cc/.claude/get-shit-done/templates/VALIDATION.md`
